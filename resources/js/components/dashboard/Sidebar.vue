<template>
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="img/dashboard/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="img/dashboard/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
<!--          </li>-->
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <b-nav-item to="/dictionary-list/statuses">
                <font-awesome-icon icon="far fa-circle" class="nav-icon" />
                <p>Statuses</p>
              </b-nav-item>
              <b-nav-item to="/dictionary-list/categories">
                <font-awesome-icon icon="far fa-circle" class="nav-icon" />
                <p>Categories</p>
              </b-nav-item>
              <b-nav-item to="/dictionary-list/authors">
                <font-awesome-icon icon="far fa-circle" class="nav-icon" />
                <p>Authors</p>
              </b-nav-item>
            </ul>
